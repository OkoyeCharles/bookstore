...
A SPA (Single Page Application) that allows users to add/remove books from a list. Built with React and Redux!
...
- Enter this url: [https://github.com/OkoyeCharles/bookstore](https://github.com/OkoyeCharles/bookstore) in your web browser.
